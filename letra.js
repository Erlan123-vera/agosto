...
var lyricsData = [
  { text: "Él la estaba esperando con una flor amarilla", time: 13 },
  { text: "Ella lo estaba soñando con la luz en su pupila", time: 23 },
  { text: "Y el amarillo del sol iluminaba la esquina (la esquina)", time: 29 },
  { text: "Lo sentía tan cercano, lo sentía desde niña", time: 39 },
  { text: "Ella sabía que él sabía, que algún día pasaría", time: 43 },
  { text: "Que vendría a buscarla, con sus flores amarillas", time: 49 },
  { text: "No te apures no detengas, el instante del encuentro", time: 55 },
  { text: "Está dicho que es un hecho, no la pierdas no hay derecho", time: 61 },
  { text: "No te olvides, que la vida", time: 64 },
  { text: "Casi nunca está dormida", time: 69 },
  { text: "En ese bar tan desierto los esperaba el encuentro (el encuentro)", time: 91 },    
  { text: "Ella llegó en limosina amarilla por supuesto", time: 102 },
  { text: "Él se acercó de repente y la miró tan de frente (de frente)", time: 107 },
  { text: "Toda una vida soñada y no pudo decir nada", time: 115 },
  { text: "Ella sabía que él sabía, que algún día pasaría", time: 120 },
  ...
  { text: "Él sabía, ella sabia", time:195 },
  { text: "Él sabía, ella sabía y se olvidaron, de sus flores amarillas", time:197 },
];
